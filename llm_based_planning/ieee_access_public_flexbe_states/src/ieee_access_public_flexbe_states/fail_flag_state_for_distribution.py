...
class FailFlagStateForDistribution(EventState):
    '''
    '''

    def __init__(self, sleep_time):
        super(FailFlagStateForDistribution, self).__init__(
                outcomes=['done'],
    ...
    def execute(self, userdata):
        ...
        Logger.loginfo(f"Behavior {self._behavior_name} failed")
        userdata.behavior_result = "failed"
