...
alpha0 = 0.3 # 0.5 
gamma0 = 0.01 # 0.03      #Hyperparameter of CRP in multinomial distribution for index of position distribution
beta0 = 0.05 # 0.001          #Hyperparameter in multinomial distribution P(W) for place names
...
n0 = 4.0 # 3.0             #Hyperparameter in Inverse Wishart distribution P(Σ) {>the number of dimenssions] (Influence degree of prior distribution of Σ)
...
object_dictionary = [
    "apple", "pig_doll", "duck_doll", "juice_bottle", "banana",
    "cup", "sponge", "chips_bag", "cracker_box", "energy_drink_can",
    "car_toy", "hand_soap", "hat"
    ]

# インクリメント
use_increment_w = False # True
increment_param = 10
